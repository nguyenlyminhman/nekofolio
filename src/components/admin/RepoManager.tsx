...
export function RepoManager() {
  ...
  const submitDialog = async () => {
    ...
    try {
      ...
      if (!editingId) {
        toast({
          variant: "destructive",
          title: "Thiếu id repo để cập nhật",
        });
        return;
      }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid h-[75vh] min-h-[520px] gap-4 lg:grid-cols-[minmax(0,280px)_minmax(0,1fr)]">
        <Card className="flex min-h-0 flex-col overflow-hidden">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <div>
              <CardTitle className="text-base">Danh sách Repo</CardTitle>
              <CardDescription>
                {listLoading ? "Đang tải…" : `${repos.length} repo`}
              </CardDescription>
            </div>
          </CardHeader>
            ...
            {detail && (
              <>
                ...
                <div>
                  ...
                  <pre className="mt-1 max-h-40 overflow-auto rounded-md border bg-muted/40 p-2 text-xs">
                    {detail.markdown || "—"}
                  </pre>
                </div>
        ...
        <DialogContent className="max-h-[92vh] overflow-y-auto sm:max-w-2xl">
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              kèm <code className="text-xs">id</code>.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="grid gap-4 py-2 sm:grid-cols-2">
            ...
            <div className="space-y-2 sm:col-span-2">
              ...
              <Textarea
                ...
                value={form.markdown}
                onChange={(e) =>
                  setForm((f) => ({ ...f, markdown: e.target.value }))
                }
              />
            </div>
              ...
              <div className="flex items-center justify-between gap-4 rounded-md border border-border px-3 py-3 sm:col-span-2">
                <div className="space-y-0.5">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Trạng thái hiển thị / kích hoạt repo.
                  </p>
                </div>
